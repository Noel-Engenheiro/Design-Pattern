...
public interface ICandidatoDAO {
    ...
    static void inserir_Candidato() {
        ...
        CandidatoDAO.inserir_Candidato(codigo_candidato, nome, sobrenome, data_de_nascimento,
    ...
    static void atualizar_Dados_Do_Candidato() throws SQLException {
        ...
        CandidatoDAO.atualizar_Dados_Do_Candidato(codigo_candidato, nome, sobrenome, data_de_nascimento,
                e_mail, cpf, pais, cep, descricao_pessoal, senha);
