...
class CandidatoDAO extends ConeccaoDAO implements ICandidatoDAO{

        public static void listar_Candidato(int i, String k, String f, String j, String s, int i1, String j1, int i2, String s1, int i3) {
        ...
        public static void inserir_Candidato(int codigo_candidato, String nome, String sobrenome, String data_de_nascimento,
        ...
        public static void atualizar_Dados_Do_Candidato(int codigo_candidato, String nome, String sobrenome, String data_de_nascimento,
